...
if (!process.env.STRIPE_SHIPPING_RATE_ID) throw new Error('Missing STRIPE_SHIPPING_RATE_ID'); // ⭐️ ADD THIS CHECK
...
exports.handler = async (event) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      shipping_options: [
        {
          // ⭐️ USE THE ENVIRONMENT VARIABLE INSTEAD OF THE HARDCODED ID ⭐️
